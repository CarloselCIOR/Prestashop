...
class __TwigTemplate_6daffc7a5ded4edcaa32e60f48e3fb44e310ea978c4a9dbc4dd714e728df38db extends Twig_Template
{
...
($context["module"] ?? null), "attributes", array()), "url_active", array()) != "buy")) {
      ...
      <div class=\"module-badges-action\">
        ...
        <div class=\"float-right module-action\">
          ";
        // line 202
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/action_menu.html.twig", "@PrestaShop/Admin/Module/Includes/modal_read_more_content.html.twig", 202)->display(array_merge($context, array("module" => ($context["module"] ?? null), "level" => ($context["level"] ?? null))));
        // line 203
        echo "        </div>
      </div>
    </div>
...
";
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Module/Includes/modal_read_more_content.html.twig", "C:\\wamp64\\www\\prestashop_1.7.5.1\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Module\\Includes\\modal_read_more_content.html.twig");
    }
}
